      ...
      <div className="absolute inset-x-0 bottom-0 p-4">
        ...
        <div className="flex items-center justify-between">
          <span className="flex items-baseline min-w-0">
            <span className="text-white/55 text-[12px] line-through mr-1.5 shrink-0">{merchant.originalPrice}</span>
            <span className="text-white text-[18px] font-bold">
              {merchant.salePrice}
              <span className="text-white/60 text-[11px] font-medium ml-1.5">E-Cash</span>
            </span>
          </span>
          <motion.button
            whileTap={{ scale: 0.94 }}
